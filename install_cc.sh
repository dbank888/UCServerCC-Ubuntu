...
function apt_install(){
	...
	apt-get -y install python-software-properties  software-properties-common unzip bzip2 postfix ncurses-dev hylafax-client hylafax-server iaxmodem cron  libncurses5-dev libncurses5 build-essential sox  make bison flex libssl-dev unzip libpcre3 libpcre3-dev unzip make sysv-rc-conf
