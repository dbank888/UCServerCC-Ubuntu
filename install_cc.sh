...
function apt_install(){
	...
	apt-get -y install python-software-properties postfix hylafax-client hylafax-server iaxmodem cron  libncurses5-dev build-essential sox  make bison flex libssl-dev unzip libpcre3 libpcre3-dev unzip make sysv-rc-conf
