...
function apt_install(){
	...
	apt-get -y install python-software-properties  unzip bzip2 postfix hylafax-client hylafax-server iaxmodem cron  libncurses5-dev libncurses5 build-essential sox  make bison flex libssl-dev unzip libpcre3 libpcre3-dev unzip make sysv-rc-conf
