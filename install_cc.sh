...
function apt_install(){
	...
	apt-get -y install python-software-properties postfix hylafax-client hylafax-server iaxmodem cron mysql-server-5.6 mysql-server-core-5.6 mysql-client-5.6 ncurses-dev build-essential sox  make bison flex libssl-dev unzip libpcre3 libpcre3-dev unzip make
